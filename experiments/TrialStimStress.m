...
function vr = initializationCodeFun(vr)
    ...
    vr.session = struct('mouse', 'TP35',...
                        'date', '190527',...
                        'run', 1,...
                        'rig', 'VR_training',...
                        'experiment', 'stress',... %'trial' or 'shock' or 'stress'
                        'basedir', '.\MATLAB\ViRMEn',...
                        'trialDuration', 60*60,...
                        'timeout', 60,...
                        'blackOutDuration', 2,...
                        'stressDur', 5*60,...
                        ...
                        'shockpos', vr.exper.userdata.minepos);
...
function vr = runtimeCodeFun(vr)
    ...
    % end the stress protocol and start the trials
    if vr.stressOn && vr.timeElapsed - vr .startTime > vr.session.stressDur
        vr.previousTime = vr.timeElapsed; 
        vr.startTime = vr.timeElapsed; 
